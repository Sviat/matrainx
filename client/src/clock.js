...
function initializeCountdown(container, date) {
    let urlSearchParams = new URLSearchParams(window.location.search);

    container.click( pauseDisplay );
    currentDisplay = new CountdownDisplay( container, date.getTime(), urlSearchParams );
    // Implementation decides on Autostarting
}

function pauseDisplay() {
    console.log("PauseDisplay");
    if( currentDisplay ) {
